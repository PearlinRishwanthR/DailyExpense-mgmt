...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            ...
            <img src="profile.jfif" class="img-responsive" alt="">
            </div>
...
<li><a class="" href="manage-income.php">
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                <em class="fa fa-navicon">&nbsp;</em>Report <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
...
<br>
        ...
        <div class="foot" style="background-color:#3b5998;color:white;margin-top:100px" align="center"> 
        <a href="www.facebook.com/pearlin.rishwanth" style="color:white;">R.Pearlin Rishwanth</a>
        <br>
