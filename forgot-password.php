...
<head>
	...
	<title>Daily Expense Record - Forgot Password</title>
    ...
    echo $msg;
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="" name="submit" class="btn btn-primary">Reset</button><span style="padding-left:265px"><a href="index.php" class="btn btn-primary">Login</a></span>
